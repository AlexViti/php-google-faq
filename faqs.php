...
$faqs = [
  "ita" => [
      ...
      'eng' => [
        [
          "question" => "What is Google Translate?",
          "answer" => [
            "Google Translate is a web translation service that lets you translate text from one language to another. It's free and always will be."
          ]
        ],
        [
          "question" => "How do I use Google Translate?",
          "answer" => [
            "To use Google Translate, click the Translate button on the left side of the screen. Then, select the language you want to translate from and the language you want to translate to. Then, type the text you want to translate in the text box on the right side of the screen. Click the Translate button to translate the text. You can also click the Translate button by using the shortcut key Ctrl + Shift + T."
          ]
        ],
        [
          "question" => "How do I change the language?",
          "answer" => [
            "To change the language, click the Translate button on the left side of the screen. Then, select the language you want to translate from and the language you want to translate to. Then, type the text you want to translate in the text box on the right side of the screen. Click the Translate button to translate the text. You can also click the Translate button by using the shortcut key Ctrl + Shift + T."
          ]
        ],
        [
          "question" => "How do I change the text I want to translate?",
          "answer" => [
            "To change the text you want to translate, click the Translate button on the left side of the screen. Then, select the language you want to translate from and the language you want to translate to. Then, type the text you want to translate in the text box on the right side of the screen. Click the Translate button to translate the text. You can also click the Translate button by using the shortcut key Ctrl + Shift + T."
          ]
        ]
      ]
  ];
